...
describe("test 'makeFortawesomeShortcode()'", () => {
  it('should be a defined function', () => {
    expect(_index.makeFortawesomeShortcode).not.toBeUndefined();
    expect(_index.makeFortawesomeShortcode).toBeType('function');
  });
  describe('test invalid arguments, function should throw with invalid/missing arguments', () => {
    it('should throw when passed no arguments', () => {
      const callWithoutArgs = () => (0, _index.makeFortawesomeShortcode)();
  ...
  it('should return a defined function', () => {
    ...
    const fortawesomeShortcode = (0, _index.makeFortawesomeShortcode)(dummyIconSet, iconSetKey);
  ...
  describe('test the svg returned by the function', () => {
    ...
    const fortawesomeShortcode = (0, _index.makeFortawesomeShortcode)(dummyIconSet, prefix);
    ...
    it('should add the expected class name', () => {
      const element = fortawesomeShortcodeToElement('github', 'social-icon');
    ...
    it('should add the expected class name, passing multiple classes', () => {
      const element = fortawesomeShortcodeToElement('github', 'social-icon,icon');
      const classNames = element.getAttribute('class').split(' ');
      expect(classNames).toContain('social-icon');
    ...
    it('should have the expected viewbox', () => {
      const element = fortawesomeShortcodeToElement('github');
      expect(element.getAttribute('viewBox')).toBe(`0 0 ${viewBoxWidth} ${viewBoxHeight}`);
    });
  });
});